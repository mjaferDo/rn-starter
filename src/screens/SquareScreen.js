...
const reducer = (state, action) => {
    ...
    // action === {colourToCHange: 'red' || 'green' || 'blue', amount: COLOUR_INCREMENT || -1 * COLOUR_INCREMENT}
    // The following is a react community convention for reducers
    // action === {type: 'change_red' || 'change_green' || 'change_blue', payload: COLOUR_INCREMENT || -1 * COLOUR_INCREMENT}
